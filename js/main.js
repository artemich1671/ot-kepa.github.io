...
$(document).ready(function () {
    ...
    $('.card-item__btn-dough').on('click', function() {
        $(this).parent('.card-item__btn').children().removeClass('active');
    ...
    $('.cards-item__btn-dough:first-child').click(function (event) {
        event.preventDefault();

        $('.card').removeClass('card-active');
        $(this).parents('.card').addClass('card-active');
        $(this).parents('.card').find('.quantity_first').css({
            'display': 'flex'
        });
        $(this).parents('.card').find('.quantity_following').css({
            'display': 'none'
        });
    });

    $('.cards-item__btn-dough:last-child').click(function (event) {
        event.preventDefault();
